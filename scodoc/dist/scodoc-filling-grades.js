...
(function(U,V){typeof exports=="object"&&typeof module<"u"?V(exports):typeof define=="function"&&define.amd?define(["exports"],V):(U=typeof globalThis<"u"?globalThis:U||self,V(U.ScodocFillingGrades={}))})(this,function(U){"use strict";var V=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function le(o){return o&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o}var J={exports:{}};(function(o,p){(function(){var y="We could not detect the separator.",h="Empty CSV. Please provide something.",_="Could not detect header. Ensure first row cotains your column headers.",C=[",",";","	"],O={",":"comma",";":"semicolon","	":"tab"};function E(d){var c={},s;return C.forEach(function(i,g){var e=new RegExp(i,"g");c[i]=(d.match(e)||[]).length,s=!s||c[i]>c[s]?i:s}),s}function M(){var d=[].slice.call(arguments),c=d.reduce(function(s,i){return s.length>i.length?s:i},[]);return c.map(function(s,i){return d.map(function(g){return g[i]})})}function L(d){for(var c={},s=0;s<d.length;s++){var i=d[s];c[i]===void 0?c[i]=0:c[i]++}for(var g=[],s=d.length-1;s>=0;s--){var i=d[s];c[i]>0&&(i=i+"__"+c[i]--),g.unshift(i)}return g}function G(d,c){if(c||(c={}),d.length==0)throw h;var s=c.separator||E(d);if(!s)throw y;var i=[];try{var i=F.parse(d,O[s])}catch(T){var g=d.lastIndexOf(`
`,T.offset),e=d.indexOf(`
`,T.offset),N=d.substring(g>=-1?g:0,e>-1?e:d.length);throw T.message+" On line "+T.line+" and column "+T.column+`.
`+N}c.transpose&&(i=M.apply(this,i));var v=i.shift();if(v.length==0)throw _;v=v.map(function(T){return T.trim().replace(/(^")|("$)/g,"")}),v=L(v);for(var u=c.hash?{}:[],w=0;w<i.length;w++){for(var q={},B,k=0;k<v.length;k++){var D=(i[w][k]||"").trim().replace(/(^")|("$)/g,""),P=D===""?NaN:D-0;if(c.hash&&k==0)B=D;else if(c.parseJSON||c.parseNumbers&&!isNaN(P))try{q[v[k]]=JSON.parse(D)}catch{q[v[k]]=D}else q[v[k]]=D}c.hash?u[B]=q:u.push(q)}return u}var F=function(){function d(s){return'"'+s.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\x08/g,"\\b").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\f/g,"\\f").replace(/\r/g,"\\r").replace(/[\x00-\x07\x0B\x0E-\x1F\x80-\uFFFF]/g,escape)+'"'}var c={parse:function(s,i){var g={comma:w,semicolon:q,tab:B,sv:k,line:D,field:P,char:T};if(i!==void 0){if(g[i]===void 0)throw new Error("Invalid rule name: "+d(i)+".")}else i="comma";var e=0,N=0,v=[];function u(n){e<N||(e>N&&(N=e,v=[]),v.push(n))}function w(){var n,t,r,l;return r=e,l=e,n=function(a){return I=","}()?"":null,n!==null?(t=k(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a,m){return m}(r,n[1])),n===null&&(e=r),n}function q(){var n,t,r,l;return r=e,l=e,n=function(a){return I=";"}()?"":null,n!==null?(t=k(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a,m){return m}(r,n[1])),n===null&&(e=r),n}function B(){var n,t,r,l;return r=e,l=e,n=function(a){return I="	"}()?"":null,n!==null?(t=k(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a,m){return m}(r,n[1])),n===null&&(e=r),n}function k(){var n,t,r,l,a,m,b,f,x;for(m=e,b=e,n=[],/^[\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[\\n\\r]"));t!==null;)n.push(t),/^[\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[\\n\\r]"));if(n!==null)if(t=D(),t!==null){if(r=[],f=e,x=e,/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]")),a!==null)for(l=[];a!==null;)l.push(a),/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));else l=null;for(l!==null?(a=D(),a!==null?l=[l,a]:(l=null,e=x)):(l=null,e=x),l!==null&&(l=function(z,S){return S}(f,l[1])),l===null&&(e=f);l!==null;){if(r.push(l),f=e,x=e,/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]")),a!==null)for(l=[];a!==null;)l.push(a),/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));else l=null;l!==null?(a=D(),a!==null?l=[l,a]:(l=null,e=x)):(l=null,e=x),l!==null&&(l=function(z,S){return S}(f,l[1])),l===null&&(e=f)}if(r!==null){for(l=[],/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));a!==null;)l.push(a),/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));l!==null?n=[n,t,r,l]:(n=null,e=b)}else n=null,e=b}else n=null,e=b;else n=null,e=b;return n!==null&&(n=function(z,S,j){return j.unshift(S),j}(m,n[1],n[2])),n===null&&(e=m),n}function D(){var n,t,r,l,a,m,b,f,x;if(m=e,b=e,n=P(),n!==null){for(t=[],f=e,x=e,s.length>e?(r=s.charAt(e),e++):(r=null,u("any character")),r!==null?(l=function(z,S){return S==I}(e,r)?"":null,l!==null?(a=P(),a!==null?r=[r,l,a]:(r=null,e=x)):(r=null,e=x)):(r=null,e=x),r!==null&&(r=function(z,S,j){return j}(f,r[0],r[2])),r===null&&(e=f);r!==null;)t.push(r),f=e,x=e,s.length>e?(r=s.charAt(e),e++):(r=null,u("any character")),r!==null?(l=function(z,S){return S==I}(e,r)?"":null,l!==null?(a=P(),a!==null?r=[r,l,a]:(r=null,e=x)):(r=null,e=x)):(r=null,e=x),r!==null&&(r=function(z,S,j){return j}(f,r[0],r[2])),r===null&&(e=f);t!==null?(r=function(z,S,j){return!!S||j.length}(e,n,t)?"":null,r!==null?n=[n,t,r]:(n=null,e=b)):(n=null,e=b)}else n=null,e=b;return n!==null&&(n=function(z,S,j){return j.unshift(S),j}(m,n[0],n[1])),n===null&&(e=m),n}function P(){var n,t,r,l,a,m;if(l=e,a=e,s.charCodeAt(e)===34?(n='"',e++):(n=null,u('"\\""')),n!==null){for(t=[],r=T();r!==null;)t.push(r),r=T();t!==null?(s.charCodeAt(e)===34?(r='"',e++):(r=null,u('"\\""')),r!==null?n=[n,t,r]:(n=null,e=a)):(n=null,e=a)}else n=null,e=a;if(n!==null&&(n=function(b,f){return f.join("")}(l,n[1])),n===null&&(e=l),n===null){for(l=e,n=[],a=e,m=e,/^[^\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[^\\n\\r]")),t!==null?(r=function(b,f){return f!=I}(e,t)?"":null,r!==null?t=[t,r]:(t=null,e=m)):(t=null,e=m),t!==null&&(t=function(b,f){return f}(a,t[0])),t===null&&(e=a);t!==null;)n.push(t),a=e,m=e,/^[^\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[^\\n\\r]")),t!==null?(r=function(b,f){return f!=I}(e,t)?"":null,r!==null?t=[t,r]:(t=null,e=m)):(t=null,e=m),t!==null&&(t=function(b,f){return f}(a,t[0])),t===null&&(e=a);n!==null&&(n=function(b,f){return f.join("")}(l,n)),n===null&&(e=l)}return n}function T(){var n,t,r,l;return r=e,l=e,s.charCodeAt(e)===34?(n='"',e++):(n=null,u('"\\""')),n!==null?(s.charCodeAt(e)===34?(t='"',e++):(t=null,u('"\\""')),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a){return'"'}()),n===null&&(e=r),n===null&&(/^[^"]/.test(s.charAt(e))?(n=s.charAt(e),e++):(n=null,u('[^"]'))),n}function ge(n){n.sort();for(var t=null,r=[],l=0;l<n.length;l++)n[l]!==t&&(r.push(n[l]),t=n[l]);return r}function ve(){for(var n=1,t=1,r=!1,l=0;l<Math.max(e,N);l++){var a=s.charAt(l);a===`
`?(r||n++,t=1,r=!1):a==="\r"||a==="\u2028"||a==="\u2029"?(n++,t=1,r=!0):(t++,r=!1)}return{line:n,column:t}}var I=",",re=g[i]();if(re===null||e!==s.length){var Q=Math.max(e,N),ye=Q<s.length?s.charAt(Q):null,te=ve();throw new this.SyntaxError(ge(v),ye,Q,te.line,te.column)}return re},toSource:function(){return this._source}};return c.SyntaxError=function(s,i,g,e,N){function v(u,w){var q,B;switch(u.length){case 0:q="end of input";break;case 1:q=u[0];break;default:q=u.slice(0,u.length-1).join(", ")+" or "+u[u.length-1]}return B=w?d(w):"end of input","Expected "+q+" but "+B+" found."}this.name="SyntaxError",this.expected=s,this.found=i,this.message=v(s,i),this.offset=g,this.line=e,this.column=N},c.SyntaxError.prototype=Error.prototype,c}();o.exports&&(p=o.exports=G),p.csv2json=G}).call(V)})(J,J.exports);var se=J.exports;const ae=le(se);let R=["Nom","Prénom","Notes"],$=[],H=[];const oe=o=>new Promise(p=>setTimeout(p,o)),A={listGradesRows:Array.from(document.querySelectorAll("tr.etud_elem")),formContainer:document.getElementById("tp-ext-form-container"),maxGrade:document.querySelector(".tf-ro-field.formnote_bareme")},Y=["","abs","exc"],Z=o=>{o.setAttribute("data-modified",!0),write_on_blur==null||write_on_blur(o)},ie=async(o,p,y)=>{p.uploadBtn.disabled=!0;const h=R[0],_=R[1],C=R[2],O=/[\u0300-\u036f]/g;for(const E of o){await oe(0);const M=p.listGradesRows.find(G=>{const F=G.getElementsByClassName("tf-fieldlabel")[0];if(!F)return;const d=F.textContent.normalize("NFD").replaceAll(O,"").replaceAll("-"," ").toLowerCase(),c=E[h].normalize("NFD").replaceAll(O,"").replaceAll("-"," ").toLowerCase(),i=E[_].normalize("NFD").replaceAll(O,"").replaceAll("-"," ").toLowerCase().split(" ").some(e=>d.includes(e)),g=c.split(" ").some(e=>d.includes(e));return i&&g});if(!M){$.push(`${E[h].toUpperCase()} ${E[_]}`);continue}const L=M.querySelector('input[class^="note"]');if(L){const G=String(E[C]).replace(",","."),F=Number.isNaN(Number(G)),d=!F,c=F?E[C]:Number(G);d&&(Y.includes(L.value.trim().toLowerCase())||c>L.value&&c<=y||L.value>y)&&(L.value=c,(c>y||c<0)&&H.push(`${E[h].toUpperCase()} ${E[_]}`),Z(L))}}},ee=()=>{document.querySelector("#grades_file").value="",A.firstStep.style.display="block",A.resetContainer.style.display="none"},ue=o=>{var y;return{isMatching:!0,scodocMaxGrade:Number(((y=o.maxGrade.textContent.match(/\d+(\.\d+)?/))==null?void 0:y[0])||20)}},ce=({target:o,valForMissingGrade:p,dom:y})=>{const h=o.target.files[0],_=h.name,C=_.lastIndexOf("."),O=["csv"],E=_.substring(C+1);if(!O.includes(E)){alert(`Votre fichier n'est pas au format ${O.join(" ou ")}`);return}const M=new FileReader;M.onload=L=>{try{new TextDecoder("utf8",{fatal:!0}).decode(L.target.result)}catch{alert("Votre fichier doit être encodé en UTF-8. Veuillez effectuer ce changement."),ee();return}M.readAsText(h),M.onload=async G=>{let F=ae(G.target.result,{parseNumbers:!0});if(F.some(u=>Object.keys(u).length!==3)){alert("Votre fichier ne contient pas que trois colonnes.");return}R=Object.keys(F[0]);const d=ue(y);$=[],H=[],await ie(F,y,d.scodocMaxGrade);const c=document.querySelector("[data-template-id='unknown-student']"),s=document.querySelector("[data-unknown-students]"),i=s.querySelector("ul");i.replaceChildren();const g=document.querySelector("[data-nb-unknown-students]");g.textContent=$.length,$.length>0?(s.style.display="",$.forEach(u=>{const w=c.content.cloneNode(!0);w.querySelector("li").textContent=u,i.append(w)})):s.style.display="none";const e=document.querySelector("[data-invalid-grades]"),N=e.querySelector("ul");N.replaceChildren();const v=document.querySelector("[data-nb-invalid-grade-students]");v.textContent=H.length,H.length>0?(e.style.display="",H.forEach(u=>{const w=c.content.cloneNode(!0);w.querySelector("li").textContent=u,N.append(w)})):e.style.display="none",Array.from(document.querySelectorAll(".note")).forEach(u=>{Y.includes(u.value.trim().toLowerCase())&&(u.value=p,Z(u))}),A.uploadBtn.disabled=!1,A.firstStep.style.display="none",A.resetContainer.style.display="block"}},M.readAsArrayBuffer(h)},W=(o,p,y,h)=>{o.addEventListener(p,function(_){let C=_.target;for(;C&&C!==this;)C.matches(y)&&h.call(C,_),C=C.parentNode})},de=()=>{document.querySelectorAll("[data-etudid]").forEach(o=>{o.setAttribute("data-modified","true"),write_on_blur==null||write_on_blur(o)})},fe=`<style>\r
