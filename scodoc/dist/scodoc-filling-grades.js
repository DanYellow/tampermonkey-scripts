...
(function(U,V){typeof exports=="object"&&typeof module<"u"?V(exports):typeof define=="function"&&define.amd?define(["exports"],V):(U=typeof globalThis<"u"?globalThis:U||self,V(U.ScodocFillingGrades={}))})(this,function(U){"use strict";var V=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function te(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var J={exports:{}};(function(i,p){(function(){var b="We could not detect the separator.",h="Empty CSV. Please provide something.",F="Could not detect header. Ensure first row cotains your column headers.",C=[",",";","	"],O={",":"comma",";":"semicolon","	":"tab"};function E(d){var c={},s;return C.forEach(function(o,v){var e=new RegExp(o,"g");c[o]=(d.match(e)||[]).length,s=!s||c[o]>c[s]?o:s}),s}function M(){var d=[].slice.call(arguments),c=d.reduce(function(s,o){return s.length>o.length?s:o},[]);return c.map(function(s,o){return d.map(function(v){return v[o]})})}function N(d){for(var c={},s=0;s<d.length;s++){var o=d[s];c[o]===void 0?c[o]=0:c[o]++}for(var v=[],s=d.length-1;s>=0;s--){var o=d[s];c[o]>0&&(o=o+"__"+c[o]--),v.unshift(o)}return v}function G(d,c){if(c||(c={}),d.length==0)throw h;var s=c.separator||E(d);if(!s)throw b;var o=[];try{var o=D.parse(d,O[s])}catch(T){var v=d.lastIndexOf(`
`,T.offset),e=d.indexOf(`
`,T.offset),q=d.substring(v>=-1?v:0,e>-1?e:d.length);throw T.message+" On line "+T.line+" and column "+T.column+`.
`+q}c.transpose&&(o=M.apply(this,o));var g=o.shift();if(g.length==0)throw F;g=g.map(function(T){return T.trim().replace(/(^")|("$)/g,"")}),g=N(g);for(var u=c.hash?{}:[],S=0;S<o.length;S++){for(var k={},B,_=0;_<g.length;_++){var j=(o[S][_]||"").trim().replace(/(^")|("$)/g,""),P=j===""?NaN:j-0;if(c.hash&&_==0)B=j;else if(c.parseJSON||c.parseNumbers&&!isNaN(P))try{k[g[_]]=JSON.parse(j)}catch{k[g[_]]=j}else k[g[_]]=j}c.hash?u[B]=k:u.push(k)}return u}var D=function(){function d(s){return'"'+s.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\x08/g,"\\b").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\f/g,"\\f").replace(/\r/g,"\\r").replace(/[\x00-\x07\x0B\x0E-\x1F\x80-\uFFFF]/g,escape)+'"'}var c={parse:function(s,o){var v={comma:S,semicolon:k,tab:B,sv:_,line:j,field:P,char:T};if(o!==void 0){if(v[o]===void 0)throw new Error("Invalid rule name: "+d(o)+".")}else o="comma";var e=0,q=0,g=[];function u(n){e<q||(e>q&&(q=e,g=[]),g.push(n))}function S(){var n,t,r,l;return r=e,l=e,n=function(a){return I=","}()?"":null,n!==null?(t=_(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a,m){return m}(r,n[1])),n===null&&(e=r),n}function k(){var n,t,r,l;return r=e,l=e,n=function(a){return I=";"}()?"":null,n!==null?(t=_(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a,m){return m}(r,n[1])),n===null&&(e=r),n}function B(){var n,t,r,l;return r=e,l=e,n=function(a){return I="	"}()?"":null,n!==null?(t=_(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a,m){return m}(r,n[1])),n===null&&(e=r),n}function _(){var n,t,r,l,a,m,y,f,x;for(m=e,y=e,n=[],/^[\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[\\n\\r]"));t!==null;)n.push(t),/^[\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[\\n\\r]"));if(n!==null)if(t=j(),t!==null){if(r=[],f=e,x=e,/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]")),a!==null)for(l=[];a!==null;)l.push(a),/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));else l=null;for(l!==null?(a=j(),a!==null?l=[l,a]:(l=null,e=x)):(l=null,e=x),l!==null&&(l=function(z,w){return w}(f,l[1])),l===null&&(e=f);l!==null;){if(r.push(l),f=e,x=e,/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]")),a!==null)for(l=[];a!==null;)l.push(a),/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));else l=null;l!==null?(a=j(),a!==null?l=[l,a]:(l=null,e=x)):(l=null,e=x),l!==null&&(l=function(z,w){return w}(f,l[1])),l===null&&(e=f)}if(r!==null){for(l=[],/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));a!==null;)l.push(a),/^[\n\r]/.test(s.charAt(e))?(a=s.charAt(e),e++):(a=null,u("[\\n\\r]"));l!==null?n=[n,t,r,l]:(n=null,e=y)}else n=null,e=y}else n=null,e=y;else n=null,e=y;return n!==null&&(n=function(z,w,L){return L.unshift(w),L}(m,n[1],n[2])),n===null&&(e=m),n}function j(){var n,t,r,l,a,m,y,f,x;if(m=e,y=e,n=P(),n!==null){for(t=[],f=e,x=e,s.length>e?(r=s.charAt(e),e++):(r=null,u("any character")),r!==null?(l=function(z,w){return w==I}(e,r)?"":null,l!==null?(a=P(),a!==null?r=[r,l,a]:(r=null,e=x)):(r=null,e=x)):(r=null,e=x),r!==null&&(r=function(z,w,L){return L}(f,r[0],r[2])),r===null&&(e=f);r!==null;)t.push(r),f=e,x=e,s.length>e?(r=s.charAt(e),e++):(r=null,u("any character")),r!==null?(l=function(z,w){return w==I}(e,r)?"":null,l!==null?(a=P(),a!==null?r=[r,l,a]:(r=null,e=x)):(r=null,e=x)):(r=null,e=x),r!==null&&(r=function(z,w,L){return L}(f,r[0],r[2])),r===null&&(e=f);t!==null?(r=function(z,w,L){return!!w||L.length}(e,n,t)?"":null,r!==null?n=[n,t,r]:(n=null,e=y)):(n=null,e=y)}else n=null,e=y;return n!==null&&(n=function(z,w,L){return L.unshift(w),L}(m,n[0],n[1])),n===null&&(e=m),n}function P(){var n,t,r,l,a,m;if(l=e,a=e,s.charCodeAt(e)===34?(n='"',e++):(n=null,u('"\\""')),n!==null){for(t=[],r=T();r!==null;)t.push(r),r=T();t!==null?(s.charCodeAt(e)===34?(r='"',e++):(r=null,u('"\\""')),r!==null?n=[n,t,r]:(n=null,e=a)):(n=null,e=a)}else n=null,e=a;if(n!==null&&(n=function(y,f){return f.join("")}(l,n[1])),n===null&&(e=l),n===null){for(l=e,n=[],a=e,m=e,/^[^\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[^\\n\\r]")),t!==null?(r=function(y,f){return f!=I}(e,t)?"":null,r!==null?t=[t,r]:(t=null,e=m)):(t=null,e=m),t!==null&&(t=function(y,f){return f}(a,t[0])),t===null&&(e=a);t!==null;)n.push(t),a=e,m=e,/^[^\n\r]/.test(s.charAt(e))?(t=s.charAt(e),e++):(t=null,u("[^\\n\\r]")),t!==null?(r=function(y,f){return f!=I}(e,t)?"":null,r!==null?t=[t,r]:(t=null,e=m)):(t=null,e=m),t!==null&&(t=function(y,f){return f}(a,t[0])),t===null&&(e=a);n!==null&&(n=function(y,f){return f.join("")}(l,n)),n===null&&(e=l)}return n}function T(){var n,t,r,l;return r=e,l=e,s.charCodeAt(e)===34?(n='"',e++):(n=null,u('"\\""')),n!==null?(s.charCodeAt(e)===34?(t='"',e++):(t=null,u('"\\""')),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(a){return'"'}()),n===null&&(e=r),n===null&&(/^[^"]/.test(s.charAt(e))?(n=s.charAt(e),e++):(n=null,u('[^"]'))),n}function he(n){n.sort();for(var t=null,r=[],l=0;l<n.length;l++)n[l]!==t&&(r.push(n[l]),t=n[l]);return r}function ve(){for(var n=1,t=1,r=!1,l=0;l<Math.max(e,q);l++){var a=s.charAt(l);a===`
`?(r||n++,t=1,r=!1):a==="\r"||a==="\u2028"||a==="\u2029"?(n++,t=1,r=!0):(t++,r=!1)}return{line:n,column:t}}var I=",",ne=v[o]();if(ne===null||e!==s.length){var Q=Math.max(e,q),ge=Q<s.length?s.charAt(Q):null,re=ve();throw new this.SyntaxError(he(g),ge,Q,re.line,re.column)}return ne},toSource:function(){return this._source}};return c.SyntaxError=function(s,o,v,e,q){function g(u,S){var k,B;switch(u.length){case 0:k="end of input";break;case 1:k=u[0];break;default:k=u.slice(0,u.length-1).join(", ")+" or "+u[u.length-1]}return B=S?d(S):"end of input","Expected "+k+" but "+B+" found."}this.name="SyntaxError",this.expected=s,this.found=o,this.message=g(s,o),this.offset=v,this.line=e,this.column=q},c.SyntaxError.prototype=Error.prototype,c}();i.exports&&(p=i.exports=G),p.csv2json=G}).call(V)})(J,J.exports);var le=J.exports;const se=te(le);let R=["Nom","Prénom","Notes"],$=[],H=[];const ae=i=>new Promise(p=>setTimeout(p,i)),A={listGradesRows:Array.from(document.querySelectorAll("tr.etud_elem")),formContainer:document.getElementById("tp-ext-form-container"),maxGrade:document.querySelector(".tf-ro-field.formnote_bareme")},Y=["","abs","exc"],oe=async(i,p,b)=>{p.uploadBtn.disabled=!0;const h=R[0],F=R[1],C=R[2],O=/[\u0300-\u036f]/g;for(const E of i){await ae(0);const M=p.listGradesRows.find(G=>{const D=G.getElementsByClassName("tf-fieldlabel")[0];if(!D)return;const d=D.textContent.normalize("NFD").replaceAll(O,"").replaceAll("-"," ").toLowerCase(),c=E[h].normalize("NFD").replaceAll(O,"").replaceAll("-"," ").toLowerCase(),o=E[F].normalize("NFD").replaceAll(O,"").replaceAll("-"," ").toLowerCase().split(" ").some(e=>d.includes(e)),v=c.split(" ").some(e=>d.includes(e));return o&&v});if(!M){$.push(`${E[h].toUpperCase()} ${E[F]}`);continue}const N=M.querySelector('input[class^="note"]');if(N){const G=String(E[C]).replace(",","."),D=Number.isNaN(Number(G)),d=!D,c=D?E[C]:Number(G);N.focus(),d&&(Y.includes(N.value.trim().toLowerCase())||c>N.value||N.value>b)&&(N.value=c,(c>b||c<0)&&H.push(`${E[h].toUpperCase()} ${E[F]}`)),N.setAttribute("data-modified",!0),write_on_blur==null||write_on_blur(N)}}},Z=()=>{document.querySelector("#grades_file").value="",A.firstStep.style.display="block",A.resetContainer.style.display="none"},ie=i=>{var b;return{isMatching:!0,scodocMaxGrade:Number(((b=i.maxGrade.textContent.match(/\d+(\.\d+)?/))==null?void 0:b[0])||20)}},ue=({target:i,valForMissingGrade:p,dom:b})=>{const h=i.target.files[0],F=h.name,C=F.lastIndexOf("."),O=["csv"],E=F.substring(C+1);if(!O.includes(E)){alert(`Votre fichier n'est pas au format ${O.join(" ou ")}`);return}const M=new FileReader;M.onload=N=>{try{new TextDecoder("utf8",{fatal:!0}).decode(N.target.result)}catch{alert("Votre fichier doit être encodé en UTF-8. Veuillez effectuer ce changement."),Z();return}M.readAsText(h),M.onload=async G=>{let D=se(G.target.result,{parseNumbers:!0});if(D.some(u=>Object.keys(u).length!==3)){alert("Votre fichier ne contient pas que trois colonnes.");return}R=Object.keys(D[0]);const d=ie(b);$=[],H=[],await oe(D,b,d.scodocMaxGrade);const c=document.querySelector("[data-template-id='unknown-student']"),s=document.querySelector("[data-unknown-students]"),o=s.querySelector("ul");o.replaceChildren();const v=document.querySelector("[data-nb-unknown-students]");v.textContent=$.length,$.length>0?(s.style.display="",$.forEach(u=>{const S=c.content.cloneNode(!0);S.querySelector("li").textContent=u,o.append(S)})):s.style.display="none";const e=document.querySelector("[data-invalid-grades]"),q=e.querySelector("ul");q.replaceChildren();const g=document.querySelector("[data-nb-invalid-grade-students]");g.textContent=H.length,H.length>0?(e.style.display="",H.forEach(u=>{const S=c.content.cloneNode(!0);S.querySelector("li").textContent=u,q.append(S)})):e.style.display="none",Array.from(document.querySelectorAll(".note")).forEach(u=>{Y.includes(u.value.trim().toLowerCase())&&(u.value=p)}),A.uploadBtn.disabled=!1,A.firstStep.style.display="none",A.resetContainer.style.display="block"}},M.readAsArrayBuffer(h)},W=(i,p,b,h)=>{i.addEventListener(p,function(F){let C=F.target;for(;C&&C!==this;)C.matches(b)&&h.call(C,F),C=C.parentNode})},ce=()=>{document.querySelectorAll("[data-etudid]").forEach(i=>{i.setAttribute("data-modified","true"),write_on_blur==null||write_on_blur(i)})},de=`<style>\r
