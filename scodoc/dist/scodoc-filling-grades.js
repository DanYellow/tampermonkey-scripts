...
(function(O,R){typeof exports=="object"&&typeof module<"u"?R(exports):typeof define=="function"&&define.amd?define(["exports"],R):(O=typeof globalThis<"u"?globalThis:O||self,R(O.ScodocFillingGrades={}))})(this,function(O){"use strict";var R=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function re(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var I={exports:{}};(function(i,m){(function(){var g="We could not detect the separator.",v="Empty CSV. Please provide something.",E="Could not detect header. Ensure first row cotains your column headers.",S=[",",";","	"],F={",":"comma",";":"semicolon","	":"tab"};function H(u){var c={},a;return S.forEach(function(o,p){var e=new RegExp(o,"g");c[o]=(u.match(e)||[]).length,a=!a||c[o]>c[a]?o:a}),a}function A(){var u=[].slice.call(arguments),c=u.reduce(function(a,o){return a.length>o.length?a:o},[]);return c.map(function(a,o){return u.map(function(p){return p[o]})})}function M(u){for(var c={},a=0;a<u.length;a++){var o=u[a];c[o]===void 0?c[o]=0:c[o]++}for(var p=[],a=u.length-1;a>=0;a--){var o=u[a];c[o]>0&&(o=o+"__"+c[o]--),p.unshift(o)}return p}function _(u,c){if(c||(c={}),u.length==0)throw v;var a=c.separator||H(u);if(!a)throw g;var o=[];try{var o=j.parse(u,F[a])}catch(D){var p=u.lastIndexOf(`
`,D.offset),e=u.indexOf(`
`,D.offset),G=u.substring(p>=-1?p:0,e>-1?e:u.length);throw D.message+" On line "+D.line+" and column "+D.column+`.
`+G}c.transpose&&(o=A.apply(this,o));var y=o.shift();if(y.length==0)throw E;y=y.map(function(D){return D.trim().replace(/(^")|("$)/g,"")}),y=M(y);for(var d=c.hash?{}:[],L=0;L<o.length;L++){for(var C={},U,k=0;k<y.length;k++){var T=(o[L][k]||"").trim().replace(/(^")|("$)/g,""),P=T===""?NaN:T-0;if(c.hash&&k==0)U=T;else if(c.parseJSON||c.parseNumbers&&!isNaN(P))try{C[y[k]]=JSON.parse(T)}catch{C[y[k]]=T}else C[y[k]]=T}c.hash?d[U]=C:d.push(C)}return d}var j=function(){function u(a){return'"'+a.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\x08/g,"\\b").replace(/\t/g,"\\t").replace(/\n/g,"\\n").replace(/\f/g,"\\f").replace(/\r/g,"\\r").replace(/[\x00-\x07\x0B\x0E-\x1F\x80-\uFFFF]/g,escape)+'"'}var c={parse:function(a,o){var p={comma:L,semicolon:C,tab:U,sv:k,line:T,field:P,char:D};if(o!==void 0){if(p[o]===void 0)throw new Error("Invalid rule name: "+u(o)+".")}else o="comma";var e=0,G=0,y=[];function d(n){e<G||(e>G&&(G=e,y=[]),y.push(n))}function L(){var n,t,r,l;return r=e,l=e,n=function(s){return B=","}()?"":null,n!==null?(t=k(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(s,h){return h}(r,n[1])),n===null&&(e=r),n}function C(){var n,t,r,l;return r=e,l=e,n=function(s){return B=";"}()?"":null,n!==null?(t=k(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(s,h){return h}(r,n[1])),n===null&&(e=r),n}function U(){var n,t,r,l;return r=e,l=e,n=function(s){return B="	"}()?"":null,n!==null?(t=k(),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(s,h){return h}(r,n[1])),n===null&&(e=r),n}function k(){var n,t,r,l,s,h,b,f,x;for(h=e,b=e,n=[],/^[\n\r]/.test(a.charAt(e))?(t=a.charAt(e),e++):(t=null,d("[\\n\\r]"));t!==null;)n.push(t),/^[\n\r]/.test(a.charAt(e))?(t=a.charAt(e),e++):(t=null,d("[\\n\\r]"));if(n!==null)if(t=T(),t!==null){if(r=[],f=e,x=e,/^[\n\r]/.test(a.charAt(e))?(s=a.charAt(e),e++):(s=null,d("[\\n\\r]")),s!==null)for(l=[];s!==null;)l.push(s),/^[\n\r]/.test(a.charAt(e))?(s=a.charAt(e),e++):(s=null,d("[\\n\\r]"));else l=null;for(l!==null?(s=T(),s!==null?l=[l,s]:(l=null,e=x)):(l=null,e=x),l!==null&&(l=function(z,w){return w}(f,l[1])),l===null&&(e=f);l!==null;){if(r.push(l),f=e,x=e,/^[\n\r]/.test(a.charAt(e))?(s=a.charAt(e),e++):(s=null,d("[\\n\\r]")),s!==null)for(l=[];s!==null;)l.push(s),/^[\n\r]/.test(a.charAt(e))?(s=a.charAt(e),e++):(s=null,d("[\\n\\r]"));else l=null;l!==null?(s=T(),s!==null?l=[l,s]:(l=null,e=x)):(l=null,e=x),l!==null&&(l=function(z,w){return w}(f,l[1])),l===null&&(e=f)}if(r!==null){for(l=[],/^[\n\r]/.test(a.charAt(e))?(s=a.charAt(e),e++):(s=null,d("[\\n\\r]"));s!==null;)l.push(s),/^[\n\r]/.test(a.charAt(e))?(s=a.charAt(e),e++):(s=null,d("[\\n\\r]"));l!==null?n=[n,t,r,l]:(n=null,e=b)}else n=null,e=b}else n=null,e=b;else n=null,e=b;return n!==null&&(n=function(z,w,q){return q.unshift(w),q}(h,n[1],n[2])),n===null&&(e=h),n}function T(){var n,t,r,l,s,h,b,f,x;if(h=e,b=e,n=P(),n!==null){for(t=[],f=e,x=e,a.length>e?(r=a.charAt(e),e++):(r=null,d("any character")),r!==null?(l=function(z,w){return w==B}(e,r)?"":null,l!==null?(s=P(),s!==null?r=[r,l,s]:(r=null,e=x)):(r=null,e=x)):(r=null,e=x),r!==null&&(r=function(z,w,q){return q}(f,r[0],r[2])),r===null&&(e=f);r!==null;)t.push(r),f=e,x=e,a.length>e?(r=a.charAt(e),e++):(r=null,d("any character")),r!==null?(l=function(z,w){return w==B}(e,r)?"":null,l!==null?(s=P(),s!==null?r=[r,l,s]:(r=null,e=x)):(r=null,e=x)):(r=null,e=x),r!==null&&(r=function(z,w,q){return q}(f,r[0],r[2])),r===null&&(e=f);t!==null?(r=function(z,w,q){return!!w||q.length}(e,n,t)?"":null,r!==null?n=[n,t,r]:(n=null,e=b)):(n=null,e=b)}else n=null,e=b;return n!==null&&(n=function(z,w,q){return q.unshift(w),q}(h,n[0],n[1])),n===null&&(e=h),n}function P(){var n,t,r,l,s,h;if(l=e,s=e,a.charCodeAt(e)===34?(n='"',e++):(n=null,d('"\\""')),n!==null){for(t=[],r=D();r!==null;)t.push(r),r=D();t!==null?(a.charCodeAt(e)===34?(r='"',e++):(r=null,d('"\\""')),r!==null?n=[n,t,r]:(n=null,e=s)):(n=null,e=s)}else n=null,e=s;if(n!==null&&(n=function(b,f){return f.join("")}(l,n[1])),n===null&&(e=l),n===null){for(l=e,n=[],s=e,h=e,/^[^\n\r]/.test(a.charAt(e))?(t=a.charAt(e),e++):(t=null,d("[^\\n\\r]")),t!==null?(r=function(b,f){return f!=B}(e,t)?"":null,r!==null?t=[t,r]:(t=null,e=h)):(t=null,e=h),t!==null&&(t=function(b,f){return f}(s,t[0])),t===null&&(e=s);t!==null;)n.push(t),s=e,h=e,/^[^\n\r]/.test(a.charAt(e))?(t=a.charAt(e),e++):(t=null,d("[^\\n\\r]")),t!==null?(r=function(b,f){return f!=B}(e,t)?"":null,r!==null?t=[t,r]:(t=null,e=h)):(t=null,e=h),t!==null&&(t=function(b,f){return f}(s,t[0])),t===null&&(e=s);n!==null&&(n=function(b,f){return f.join("")}(l,n)),n===null&&(e=l)}return n}function D(){var n,t,r,l;return r=e,l=e,a.charCodeAt(e)===34?(n='"',e++):(n=null,d('"\\""')),n!==null?(a.charCodeAt(e)===34?(t='"',e++):(t=null,d('"\\""')),t!==null?n=[n,t]:(n=null,e=l)):(n=null,e=l),n!==null&&(n=function(s){return'"'}()),n===null&&(e=r),n===null&&(/^[^"]/.test(a.charAt(e))?(n=a.charAt(e),e++):(n=null,d('[^"]'))),n}function pe(n){n.sort();for(var t=null,r=[],l=0;l<n.length;l++)n[l]!==t&&(r.push(n[l]),t=n[l]);return r}function me(){for(var n=1,t=1,r=!1,l=0;l<Math.max(e,G);l++){var s=a.charAt(l);s===`
`?(r||n++,t=1,r=!1):s==="\r"||s==="\u2028"||s==="\u2029"?(n++,t=1,r=!0):(t++,r=!1)}return{line:n,column:t}}var B=",",ee=p[o]();if(ee===null||e!==a.length){var Q=Math.max(e,G),he=Q<a.length?a.charAt(Q):null,ne=me();throw new this.SyntaxError(pe(y),he,Q,ne.line,ne.column)}return ee},toSource:function(){return this._source}};return c.SyntaxError=function(a,o,p,e,G){function y(d,L){var C,U;switch(d.length){case 0:C="end of input";break;case 1:C=d[0];break;default:C=d.slice(0,d.length-1).join(", ")+" or "+d[d.length-1]}return U=L?u(L):"end of input","Expected "+C+" but "+U+" found."}this.name="SyntaxError",this.expected=a,this.found=o,this.message=y(a,o),this.offset=p,this.line=e,this.column=G},c.SyntaxError.prototype=Error.prototype,c}();i.exports&&(m=i.exports=_),m.csv2json=_}).call(R)})(I,I.exports);var te=I.exports;const le=re(te);let $=["Nom","Prénom","Notes"],V=[];const ae=i=>new Promise(m=>setTimeout(m,i)),N={listGradesRows:Array.from(document.querySelectorAll("tr.etud_elem")),formContainer:document.getElementById("tp-ext-form-container"),maxGrade:document.querySelector(".tf-ro-field.formnote_bareme")},se=async(i,m)=>{const g=$[0],v=$[1],E=$[2],S=/[\u0300-\u036f]/g;for(const F of i){await ae(0);const H=m.listGradesRows.find(M=>{const _=M.getElementsByClassName("tf-fieldlabel")[0];if(!_)return;const j=_.textContent.normalize("NFD").replaceAll(S,"").replaceAll("-"," ").toLowerCase(),u=F[g].normalize("NFD").replaceAll(S,"").replaceAll("-"," ").toLowerCase(),a=F[v].normalize("NFD").replaceAll(S,"").replaceAll("-"," ").toLowerCase().split(" ").some(p=>j.includes(p)),o=u.split(" ").some(p=>j.includes(p));return a&&o});if(!H){V.push(`${F[g]} ${F[v]}`);continue}const A=H.querySelector('input[class^="note"]');if(A){document.body.click();const M=String(F[E]).replace(",","."),_=Number.isNaN(Number(M)),j=!_,u=_?F[E]:Number(M);A.focus(),j&&(!A.value.trim()||u>A.value)&&(A.value=u),A.setAttribute("data-modified",!0),write_on_blur==null||write_on_blur(A)}}},J=()=>{document.querySelector("#grades_file").value="",N.firstStep.style.display="block",N.resetContainer.style.display="none"},oe=i=>{const m=i.maxGrade.textContent.match(/\d+(\.\d+)?/)[0],v=$.find(E=>E.toLowerCase().includes("note")).replace(",",".").match(/\d+(\.\d+)?/)[0];return{isMatching:Number(v)===Number(m),scodocMaxGrade:m,fileMaxGrade:v}},ie=({target:i,valForMissingGrade:m,dom:g})=>{const v=i.target.files[0],E=v.name,S=E.lastIndexOf("."),F=["csv"],H=E.substring(S+1);if(!F.includes(H)){alert(`Votre fichier n'est pas au format ${F.join(" ou ")}`);return}const A=new FileReader;A.onload=M=>{try{new TextDecoder("utf8",{fatal:!0}).decode(M.target.result)}catch{alert("Votre fichier doit être encodé en UTF-8. Veuillez effectuer ce changement."),J();return}A.readAsText(v),A.onload=async _=>{let j=le(_.target.result,{parseNumbers:!0});if(j.some(p=>Object.keys(p).length!==3)){alert("Votre fichier ne contient pas que trois colonnes.");return}$=Object.keys(j[0]);const u=oe(g);if(!u.isMatching){alert(`
